...
from lib import check_gz, prepare, hist
...
def parse_args() -> argparse.Namespace:
    ...
    hist_parser = subparsers.add_parser(
        'hist', help='make histograms on metadata',
    )
    hist_parser.add_argument("--data", type=str, action="store", help="input vcf data")
    hist_parser.add_argument("--meta", type=str, action="store", help="metadataset")
    hist_parser.add_argument("--output", type=str, action="store", help="output data with histogram lists")
